...
local default_keymaps = {
	...
	{ keys = "gr", func = vim.lsp.buf.references, desc = "Goto Definition", has = "definitionProvider" },
}
...
-- Load Lsp on-demand, e.g: biome is disabled by default
-- e.g: We could enable biome by set vim.g.lsp_on_demands = {"biome"}
